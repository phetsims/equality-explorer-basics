 ...
 * please modify equality-explorer-basics/package.json to control dependencies.
 *
 * RequireJS configuration file for the equality-explorer-basics sim.
 * Paths are relative to the location of this file.
 */

require.config( {

  deps: [ 'equality-explorer-basics-main' ],
